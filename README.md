...
## Data Sources
- **Primary Dataset**: Customer reviews gotten from https://github.com/mochen862/tableau-end-to-end-portfolio-project/blob/main/ba_reviews.csv
...
Link to Tableau Public https://public.tableau.com/views/BritishAirwaysReviews_17682633728490/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link
